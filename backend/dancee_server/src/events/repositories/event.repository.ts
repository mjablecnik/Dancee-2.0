  ...
  private async initializeSampleData(): Promise<void> {
    ...
    const sampleEvents: EventDto[] = [
      ...
      },
      {
        ...
        startTime: new Date(
          now.getTime() + 7 * 24 * 60 * 60 * 1000 + 19.5 * 60 * 60 * 1000,
        ).toISOString(),
        endTime: new Date(
          now.getTime() + 7 * 24 * 60 * 60 * 1000 + 23.5 * 60 * 60 * 1000,
        ).toISOString(),
        ...
        parts: [
          {
            ...
            description:
              'Intermediate level workshop focusing on body movement',
            type: 'workshop',
            startTime: new Date(
              now.getTime() + 7 * 24 * 60 * 60 * 1000 + 19.5 * 60 * 60 * 1000,
            ).toISOString(),
            endTime: new Date(
              now.getTime() + 7 * 24 * 60 * 60 * 1000 + 21 * 60 * 60 * 1000,
            ).toISOString(),
        ...
        parts: [
          {
            ...
            type: 'party',
            startTime: new Date(
              now.getTime() + 14 * 24 * 60 * 60 * 1000 + 21 * 60 * 60 * 1000,
            ).toISOString(),
            endTime: new Date(
      ...
      },
      {
        ...
        startTime: new Date(
          now.getTime() + 3 * 24 * 60 * 60 * 1000 + 18 * 60 * 60 * 1000,
        ).toISOString(),
        endTime: new Date(
          now.getTime() + 3 * 24 * 60 * 60 * 1000 + 20 * 60 * 60 * 1000,
        ).toISOString(),
      ...
      },
      {
        ...
        startTime: new Date(
          now.getTime() + 10 * 24 * 60 * 60 * 1000 + 20 * 60 * 60 * 1000,
        ).toISOString(),
        endTime: new Date(
          now.getTime() + 11 * 24 * 60 * 60 * 1000 + 1 * 60 * 60 * 1000,
        ).toISOString(),
      ...
      },
      {
        ...
        startTime: new Date(
          now.getTime() + 21 * 24 * 60 * 60 * 1000 + 10 * 60 * 60 * 1000,
        ).toISOString(),
        endTime: new Date(
          now.getTime() + 23 * 24 * 60 * 60 * 1000 + 2 * 60 * 60 * 1000,
        ).toISOString(),
        ...
        parts: [
          {
            ...
            endTime: new Date(
              now.getTime() + 21 * 24 * 60 * 60 * 1000 + 18 * 60 * 60 * 1000,
            ).toISOString(),
          ...
          },
          {
            ...
            type: 'party',
            startTime: new Date(
              now.getTime() + 21 * 24 * 60 * 60 * 1000 + 21 * 60 * 60 * 1000,
            ).toISOString(),
            endTime: new Date(
      ...
      },
      {
        ...
        startTime: new Date(
          now.getTime() + 2 * 24 * 60 * 60 * 1000 + 21 * 60 * 60 * 1000,
        ).toISOString(),
        endTime: new Date(
      ...
      },
      {
        ...
        startTime: new Date(
          now.getTime() + 8 * 24 * 60 * 60 * 1000 + 19 * 60 * 60 * 1000,
        ).toISOString(),
        endTime: new Date(
          now.getTime() + 8 * 24 * 60 * 60 * 1000 + 21 * 60 * 60 * 1000,
        ).toISOString(),
        duration: 2 * 60 * 60 * 1000,
