...
export class VenueDto {
  ...
  @ApiPropertyOptional({
    ...
    example: 'Historic music venue in the heart of Prague',
  })
  description?: string;
...
export class EventPartDto {
  ...
  @ApiPropertyOptional({
    ...
    example: 'Open social dancing with live band',
  })
  description?: string;

  @ApiProperty({
    description: 'Part type',
    enum: ['party', 'workshop', 'openLesson', 'course'],
    example: 'party',
  })
  type: string;
  ...
  @ApiProperty({
    ...
    example: '2024-02-15T20:00:00Z',
  })
  startTime: string;

  @ApiPropertyOptional({
    description: 'End time (ISO 8601)',
    example: '2024-02-16T02:00:00Z',
  })
  endTime?: string;

  @ApiPropertyOptional({
    description: 'List of DJs',
    type: [String],
    example: ['DJ Carlos', 'DJ Maria'],
  })
  djs?: string[];

  @ApiPropertyOptional({
    description: 'List of lectors/instructors',
    type: [String],
    example: ['Carlos & Maria'],
  })
  lectors?: string[];
}
...
export class EventDto {
  ...
  @ApiPropertyOptional({
    ...
    example: 'Join us for an amazing night of Salsa dancing!',
  })
  description?: string;
  ...
  @ApiProperty({
    description: 'List of dance styles',
    type: [String],
  ...
  @ApiPropertyOptional({
    description: 'Event parts/segments',
    type: [EventPartDto],
  })
  parts?: EventPartDto[];

  @ApiPropertyOptional({
    description: 'Whether event is marked as favorite',
    example: false,
  })
  isFavorite?: boolean;
}
