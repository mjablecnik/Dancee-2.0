...
- [ ] 9. [MEDIUM] Add property-based test (fast-check) for Property 3: info_translations length matches info array length
- [ ] 10. [MEDIUM] Fix mislabeled Property 8 test and add actual Property 8 test for parent dance style filtering
- [ ] 11. [MEDIUM] Add API endpoints for listing courses and managing favorites, or document that these use Directus directly
