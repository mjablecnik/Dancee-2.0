  ...
  Future<List<FeaturedCourseData>> getFeaturedCourses() async {
    return const [
      ...
      FeaturedCourseData(
        ...
        levelLabel: 'Mírně pokročilí',
        levelColor: appLavender,
        title: 'Kizomba Fusion Workshop',
        instructor: 'Dance Academy Brno',
        dateRange: '10. Bře - 20. Kvě 2025',
        styleLabel: 'Kizomba',
      ...
      FeaturedCourseData(
        ...
        levelLabel: 'Začátečníci',
        levelColor: appTeal,
        title: 'Brazilian Zouk pro začátečníky',
        instructor: 'Rodrigo Silva',
        dateRange: '5. Dub - 25. Čer 2025',
        styleLabel: 'Zouk',
        styleColor: appTeal,
        price: '2 200 Kč',
      ),
      FeaturedCourseData(
        ...
        levelLabel: 'Začátečníci',
        levelColor: appCyan,
        title: 'Lindy Hop - Swing pro začátečníky',
        instructor: 'Swing Time Praha',
        dateRange: '1. Kvě - 30. Čer 2025',
        styleLabel: 'Swing',
        styleColor: appGold,
        price: '2 700 Kč',
      ),
