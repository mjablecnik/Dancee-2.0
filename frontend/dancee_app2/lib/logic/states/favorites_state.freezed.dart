...
mixin _$FavoritesState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(Set<int> eventIds, Set<int> courseIds) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(Set<int> eventIds, Set<int> courseIds)? loaded,
...
abstract class _$$LoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({Set<int> eventIds, Set<int> courseIds});
}
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(
      {required final Set<int> eventIds, required final Set<int> courseIds})
      : _eventIds = eventIds,
        _courseIds = courseIds;

  final Set<int> _eventIds;
  @override
  Set<int> get eventIds {
    if (_eventIds is EqualUnmodifiableSetView) return _eventIds;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableSetView(_eventIds);
  }

  final Set<int> _courseIds;
  @override
  Set<int> get courseIds {
    if (_courseIds is EqualUnmodifiableSetView) return _courseIds;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableSetView(_courseIds);
  }

  @override
  String toString() {
    return 'FavoritesState.loaded(eventIds: $eventIds, courseIds: $courseIds)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return loaded(eventIds, courseIds);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return loaded?.call(eventIds, courseIds);
  }
...
abstract class _Loaded implements FavoritesState {
  const factory _Loaded(
      {required final Set<int> eventIds,
      required final Set<int> courseIds}) = _$LoadedImpl;
