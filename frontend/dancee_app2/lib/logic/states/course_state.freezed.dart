...
mixin _$CourseState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(
            List<Course> allCourses, List<Course> filteredCourses)
        loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<Course> allCourses, List<Course> filteredCourses)?
        loaded,
...
abstract class _$$LoadedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Course> allCourses, List<Course> filteredCourses});
}

/// @nodoc
class __$$LoadedImplCopyWithImpl<$Res>
    extends _$CourseStateCopyWithImpl<$Res, _$LoadedImpl>
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(
      {required final List<Course> allCourses,
      required final List<Course> filteredCourses})
  ...
  @override
  String toString() {
    return 'CourseState.loaded(allCourses: $allCourses, filteredCourses: $filteredCourses)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return loaded(allCourses, filteredCourses);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return loaded?.call(allCourses, filteredCourses);
  }
...
abstract class _Loaded implements CourseState {
  const factory _Loaded(
      {required final List<Course> allCourses,
      required final List<Course> filteredCourses}) = _$LoadedImpl;
...
class __$$ErrorImplCopyWithImpl<$Res>
    extends _$CourseStateCopyWithImpl<$Res, _$ErrorImpl>
