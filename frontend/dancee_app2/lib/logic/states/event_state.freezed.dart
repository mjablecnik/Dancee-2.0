...
mixin _$EventState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<Event> allEvents, List<Event> filteredEvents,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<Event> allEvents, List<Event> filteredEvents,
            List<Event> featuredEvents)?
        loaded,
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(
      {required final List<Event> allEvents,
      required final List<Event> filteredEvents,
      required final List<Event> featuredEvents})
  ...
  @override
  String toString() {
    return 'EventState.loaded(allEvents: $allEvents, filteredEvents: $filteredEvents, featuredEvents: $featuredEvents)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return loaded(allEvents, filteredEvents, featuredEvents);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return loaded?.call(allEvents, filteredEvents, featuredEvents);
  }
...
abstract class _Loaded implements EventState {
  const factory _Loaded(
      {required final List<Event> allEvents,
      required final List<Event> filteredEvents,
      required final List<Event> featuredEvents}) = _$LoadedImpl;
