...
- [x] 1. Add Dio dependency and create core infrastructure
...
- [ ] 2. Implement ApiClient wrapper for Dio
  ...
  - [x] 2.2 Implement HTTP methods (GET, POST, DELETE)
...
- [x] 3. Add translation keys for API errors
...
- [ ] 4. Implement EventRepository (Pure Data Access Layer)
  - [x] 4.1 Create EventRepository class
  ...
  - [x] 4.2 Implement getAllEvents() with API call
  ...
  - [x] 4.3 Implement getFavoriteEvents() with API call
  ...
  - [x] 4.4 Implement addFavorite() with API call
  ...
  - [x] 4.5 Implement removeFavorite() with API call
  ...
  - [x] 4.6 Implement toggleFavorite() helper method
...
- [x] 5. Checkpoint - Verify API integration works
...
- [ ] 6. Update EventListCubit with business logic
  - [x] 6.1 Update EventListCubit constructor
    - Keep EventRepository parameter (no changes needed)
    - _Requirements: 12.2, 12.3_
  
  - [x] 6.2 Update loadEvents() method
  ...
  - [x] 6.3 Implement searchEvents() method
  ...
  - [x] 6.4 Update toggleFavorite() method
...
- [ ] 7. Update FavoritesCubit with business logic
  - [x] 7.1 Update FavoritesCubit constructor
    - Keep EventRepository parameter (no changes needed)
    - _Requirements: 12.2, 12.3_
  
  - [x] 7.2 Update loadFavorites() method
  ...
  - [x] 7.3 Update toggleFavorite() method
...
- [ ] 9. Update UI screens for error display
  - [x] 9.1 Update EventListScreen error handling
  ...
  - [x] 9.2 Update FavoritesScreen error handling
    - Display error icon and translated error message
