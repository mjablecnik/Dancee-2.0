...
- [ ] 1. Scaffold project structure and configuration
  - [ ] 1.1 Initialize the project with Bun and configure TypeScript
  ...
  - [ ] 1.3 Implement `src/core/config.ts` — environment config loader and Sentry initialization
  ...
  - [ ] 1.4 Implement `src/core/schemas.ts` — Zod schemas and TypeScript types
  ...
  - [ ]* 1.5 Write property tests for core utility functions
  ...
  - [ ] 1.6 Implement `src/core/prompts.ts` — LLM prompt templates
...
- [ ] 2. Implement HTTP clients for external services
  - [ ] 2.1 Implement `src/clients/scraper-client.ts`
  ...
  - [ ] 2.4 Implement `src/clients/directus-client.ts`
  ...
  - [ ]* 2.5 Write property tests for Directus client deduplication and ordering
...
- [ ] 4. Implement business logic services
  - [ ] 4.1 Implement `src/services/event-parser.ts` — LLM-based classification and extraction
  ...
  - [ ] 4.2 Implement `src/services/event-translator.ts` — LLM-based translation
  ...
  - [ ]* 4.3 Write property tests for translation logic
  ...
  - [ ] 4.4 Implement `src/services/venue-resolver.ts` — venue resolution with geocoding
...
- [ ] 6. Implement Restate workflows and API service
  - [ ] 6.1 Implement `src/services/workflow.ts` — single event processing workflow
  ...
  - [ ]* 6.2 Write property tests for workflow event processing
  ...
  - [ ] 6.3 Implement `src/services/batch.ts` — batch processing service
  ...
  - [ ] 6.4 Implement `src/services/api.ts` — Restate API service with CORS
  ...
  - [ ]* 6.5 Write property test for API validation
  ...
  - [ ] 6.6 Implement `src/index.ts` — entry point
...
- [ ] 8. Implement setup script and Docker configuration
  - [ ] 8.1 Implement `scripts/setup-directus.ts` — Directus collection setup CLI script
  ...
  - [ ] 8.2 Create Docker and deployment configuration
